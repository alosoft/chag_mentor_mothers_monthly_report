$.fn.addCommas = function(e) { for (var t = (e += "").split("."), a = t[0], n = t.length > 1 ? "." + t[1] : "", o = /(\d+)(\d{3})/; o.test(a);) a = a.replace(o, "$1,$2"); return a + n },
    function(e) { e.fn.stateButton = function(t) { return this.length > 1 ? (this.each((function() { e(this).stateButton(t) })), this) : (this.initialize = function() { return this }, this.showSpinner = function() { return e(this).addClass("show-spinner"), e(this).addClass("active"), this }, this.hideSpinner = function() { return e(this).removeClass("show-spinner"), this }, this.showFail = function(t) { return e(this).addClass("show-fail"), e(this).removeClass("show-spinner"), t && e(this).find(".icon.fail").tooltip("show"), this }, this.showSuccess = function(t) { return e(this).addClass("show-success"), e(this).removeClass("show-spinner"), t && e(this).find(".icon.success").tooltip("show"), this }, this.reset = function() { this.hideTooltips(), this.hideSpinner(), e(this).removeClass("show-success"), e(this).removeClass("show-fail"), e(this).removeClass("active") }, this.hideTooltips = function() { return this.hideFailTooltip(), this.hideSuccessTooltip(), this }, this.showSuccessTooltip = function() { return e(this).find(".icon.success").tooltip("show"), this }, this.hideSuccessTooltip = function() { return e(this).find(".icon.success").tooltip("dispose"), this }, this.showFailTooltip = function() { return e(this).find(".icon.fail").tooltip("show"), this }, this.hideFailTooltip = function() { return e(this).find(".icon.fail").tooltip("dispose"), this }, this.initialize()) } }(jQuery), $.shiftSelectable = function(e, t) {
        var a = this;
        ...
        function s(e, t) {
            ...
            if (i) {
                var s = !1,
                    d = !0;
                r.each((function() { $(this).prop("checked") ? s = !0 : d = !1 })), s ? i.prop("indeterminate", s) : (i.prop("indeterminate", s), i.prop("checked", s)), d && (i.prop("indeterminate", !1), i.prop("checked", d))
            }
            document.activeElement.blur(), l()
        }

        function l() { r.each((function() { $(this).prop("checked") ? $(this).parents(".card").addClass("active") : $(this).parents(".card").removeClass("active") })) }
        o.data("checkAll") && (i = $("#" + o.data("checkAll"))).on("click", (function() { r.prop("checked", $(i).prop("checked")).trigger("change"), document.activeElement.blur(), l() })), o.on("click", t.items, (function(e) { $(e.target).is("a") || $(e.target).parent().is("a") || ($(e.target).is("input[type='checkbox']") && (e.preventDefault(), e.stopPropagation()), s($(this).find("input[type='checkbox']")[0], e.shiftKey)) })), a.update = function() { r = o.find("input[type='checkbox']") }, a.selectAll = function() { i && (r.prop("checked", !0).trigger("change"), i.prop("checked", !0), i.prop("indeterminate", !1), l()) }, a.deSelectAll = function() { i && (r.prop("checked", !1).trigger("change"), i.prop("checked", !1), i.prop("indeterminate", !1), l()) }, a.rightClick = function(e) {
        ...
        ! function() {
            Ce = Ce || {}, n.settings = $.extend({}, a, Ce),
                function() { try { localStorage.getItem("dore-direction") && (o = localStorage.getItem("dore-direction")), i = "rtl" == o && !0 } catch (e) { i = !1 } }();
            ...
            function y() { $(".search").hasClass("mobile-view") && ($(".search").removeClass("mobile-view"), $(".search input").val("")) }
            $(window).on("resize", (function(e) { e.originalEvent.isTrusted && C() })), C(), $(".search .search-icon").on("click", (function() { $(window).outerWidth() < 768 ? $(".search").hasClass("mobile-view") ? ($(".search").removeClass("mobile-view"), w()) : ($(".search").addClass("mobile-view"), $(".search input").focus()) : w() })), $(".search input").on("keyup", (function(e) { 13 == e.which && w(), 27 == e.which && y() })), $(document).on("click", (function(e) { $(e.target).parents().hasClass("search") || y() })), $(".list").shiftSelectable();
            var v = 0,
            ...
            function S() { var e = $(".main-menu ul li.active a").attr("href"); return e ? e.replace("#", "") : "" }

            function B(e) { return $("#app-container").attr("class").split(" ").filter((function(e) { return "" != e })).includes(e) }
            $(".menu-button").on("click", (function(e) { e.preventDefault(), x(++v) })), $(".menu-button-mobile").on("click", (function(e) { return e.preventDefault(), $("#app-container").removeClass("sub-show-temporary").toggleClass("main-show-temporary"), !1 })), $(".main-menu").on("click", "a", (function(e) {
                e.preventDefault();
            ...
            function T(e) {
                if (0 != $(".main-menu").length) {
                    var t = e ? e.replace("#", "") : "";
                    if (0 == $(".sub-menu ul[data-link='" + t + "']").length) { if ($("#app-container").removeClass("sub-show-temporary"), 0 == $("#app-container").length) return; return v = B("menu-sub-hidden") || B("menu-hidden") ? 0 : 1, $("#app-container").addClass("sub-hidden"), $(".sub-menu").addClass("no-transition"), $("main").addClass("no-transition"), void setTimeout((function() { $(".sub-menu").removeClass("no-transition"), $("main").removeClass("no-transition") }), 350) }
            ...
            if (T($(".main-menu ul li.active a").attr("href")), $(".app-menu-button").on("click", (function(e) { e.preventDefault(), $(".app-menu").hasClass("shown") ? $(".app-menu").removeClass("shown") : $(".app-menu").addClass("shown") })), $(document).on("click", (function(e) { $(e.target).parents().hasClass("app-menu") || $(e.target).parents().hasClass("app-menu-button") || $(e.target).hasClass("app-menu-button") || $(e.target).hasClass("app-menu") || $(".app-menu").hasClass("shown") && $(".app-menu").removeClass("shown") })), $(document).on("click", ".question .view-button", (function() { E($(this)) })), $(document).on("click", ".question .edit-button", (function() { E($(this)) })), $(document).on("click", ".rotate-icon-click", (function() { $(this).toggleClass("rotate") })), "undefined" != typeof Chart) {
                ...
                var z = { backgroundColor: f, titleFontColor: g, borderColor: b, borderWidth: .5, bodyFontColor: g, bodySpacing: 10, xPadding: 15, yPadding: 15, cornerRadius: .15, displayColors: !1 };
                if (document.getElementById("visitChartFull")) {
                    var D = document.getElementById("visitChartFull").getContext("2d");
                    new Chart(D, { type: "LineWithShadow", data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "Data", borderColor: t, pointBorderColor: t, pointBackgroundColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: t, pointRadius: 3, pointBorderWidth: 3, pointHoverRadius: 3, fill: !0, backgroundColor: c, borderWidth: 2, data: [180, 140, 150, 120, 180, 110, 160], datalabels: { align: "end", anchor: "end" } }] }, options: { layout: { padding: { left: 0, right: 0, top: 40, bottom: 0 } }, plugins: { datalabels: { backgroundColor: "transparent", borderRadius: 30, borderWidth: 1, padding: 5, borderColor: function(e) { return e.dataset.borderColor }, color: function(e) { return e.dataset.borderColor }, font: { weight: "bold", size: 10 }, formatter: Math.round } }, responsive: !0, maintainAspectRatio: !1, legend: { display: !1 }, tooltips: z, scales: { yAxes: [{ ticks: { min: 0 }, display: !1 }], xAxes: [{ ticks: { min: 0 }, display: !1 }] } } })
                }
                if (document.getElementById("visitChart")) {
                    var I = document.getElementById("visitChart").getContext("2d");
                    new Chart(I, { type: "LineWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 0 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [54, 63, 60, 65, 60, 68, 60], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 4, pointBorderWidth: 2, pointHoverRadius: 5, fill: !0, borderWidth: 2, backgroundColor: c }] } })
                }
                if (document.getElementById("conversionChart")) {
                    var P = document.getElementById("conversionChart").getContext("2d");
                    new Chart(P, { type: "LineWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 0 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [65, 60, 68, 54, 63, 60, 60], borderColor: r, pointBackgroundColor: f, pointBorderColor: r, pointHoverBackgroundColor: r, pointHoverBorderColor: f, pointRadius: 4, pointBorderWidth: 2, pointHoverRadius: 5, fill: !0, borderWidth: 2, backgroundColor: p }] } })
                }
                var R = {
                ...
                if (document.getElementById("smallChart1")) {
                    ...
                    new Chart(F, { type: "LineWithLine", plugins: [L], data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "Total Orders", borderColor: t, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: t, pointRadius: 2, pointBorderWidth: 3, pointHoverRadius: 2, fill: !1, borderWidth: 2, data: [1250, 1300, 1550, 921, 1810, 1106, 1610], datalabels: { align: "end", anchor: "end" } }] }, options: R })
                }
                if (document.getElementById("smallChart2")) {
                    var M = document.getElementById("smallChart2").getContext("2d");
                    new Chart(M, { type: "LineWithLine", plugins: [L], data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "Pending Orders", borderColor: t, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: t, pointRadius: 2, pointBorderWidth: 3, pointHoverRadius: 2, fill: !1, borderWidth: 2, data: [115, 120, 300, 222, 105, 85, 36], datalabels: { align: "end", anchor: "end" } }] }, options: R })
                }
                if (document.getElementById("smallChart3")) {
                    var H = document.getElementById("smallChart3").getContext("2d");
                    new Chart(H, { type: "LineWithLine", plugins: [L], data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "Active Orders", borderColor: t, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: t, pointRadius: 2, pointBorderWidth: 3, pointHoverRadius: 2, fill: !1, borderWidth: 2, data: [350, 452, 762, 952, 630, 85, 158], datalabels: { align: "end", anchor: "end" } }] }, options: R })
                }
                if (document.getElementById("smallChart4")) {
                    var V = document.getElementById("smallChart4").getContext("2d");
                    new Chart(V, { type: "LineWithLine", plugins: [L], data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "Shipped Orders", borderColor: t, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: t, pointRadius: 2, pointBorderWidth: 3, pointHoverRadius: 2, fill: !1, borderWidth: 2, data: [200, 452, 250, 630, 125, 85, 20], datalabels: { align: "end", anchor: "end" } }] }, options: R })
                }
                if (document.getElementById("salesChart")) {
                    var _ = document.getElementById("salesChart").getContext("2d");
                    new Chart(_, { type: "LineWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 20 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [54, 63, 60, 65, 60, 68, 60], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 6, pointBorderWidth: 2, pointHoverRadius: 8, fill: !1 }] } })
                }
                if (document.getElementById("areaChart")) {
                    var N = document.getElementById("areaChart").getContext("2d");
                    new Chart(N, { type: "LineWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 0 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [54, 63, 60, 65, 60, 68, 60], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 4, pointBorderWidth: 2, pointHoverRadius: 5, fill: !0, borderWidth: 2, backgroundColor: c }] } })
                }
                if (document.getElementById("areaChartNoShadow")) {
                    var q = document.getElementById("areaChartNoShadow").getContext("2d");
                    new Chart(q, { type: "line", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 0 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [54, 63, 60, 65, 60, 68, 60], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 4, pointBorderWidth: 2, pointHoverRadius: 5, fill: !0, borderWidth: 2, backgroundColor: c }] } })
                }
                if (document.getElementById("scatterChart")) {
                    var O = document.getElementById("scatterChart").getContext("2d");
                    new Chart(O, { type: "ScatterWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 20, min: -80, max: 80, padding: 20 } }], xAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)" } }] }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ borderWidth: 2, label: "Cakes", borderColor: t, backgroundColor: c, data: [{ x: 62, y: -78 }, { x: -0, y: 74 }, { x: -67, y: 45 }, { x: -26, y: -43 }, { x: -15, y: -30 }, { x: 65, y: -68 }, { x: -28, y: -61 }] }, { borderWidth: 2, label: "Desserts", borderColor: r, backgroundColor: p, data: [{ x: 79, y: 62 }, { x: 62, y: 0 }, { x: -76, y: -81 }, { x: -51, y: 41 }, { x: -9, y: 9 }, { x: 72, y: -37 }, { x: 62, y: -26 }] }] } })
                }
                if (document.getElementById("scatterChartNoShadow")) {
                    var U = document.getElementById("scatterChartNoShadow").getContext("2d");
                    new Chart(U, { type: "scatter", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 20, min: -80, max: 80, padding: 20 } }], xAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)" } }] }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ borderWidth: 2, label: "Cakes", borderColor: t, backgroundColor: c, data: [{ x: 62, y: -78 }, { x: -0, y: 74 }, { x: -67, y: 45 }, { x: -26, y: -43 }, { x: -15, y: -30 }, { x: 65, y: -68 }, { x: -28, y: -61 }] }, { borderWidth: 2, label: "Desserts", borderColor: r, backgroundColor: p, data: [{ x: 79, y: 62 }, { x: 62, y: 0 }, { x: -76, y: -81 }, { x: -51, y: 41 }, { x: -9, y: 9 }, { x: 72, y: -37 }, { x: 62, y: -26 }] }] } })
                }
                if (document.getElementById("radarChartNoShadow")) {
                    var Z = document.getElementById("radarChartNoShadow").getContext("2d");
                    new Chart(Z, { type: "radar", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scale: { ticks: { display: !1 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: t, backgroundColor: c, data: [80, 90, 70] }, { label: "Order", borderWidth: 2, pointBackgroundColor: r, borderColor: r, backgroundColor: p, data: [68, 80, 95] }], labels: ["Cakes", "Desserts", "Cupcakes"] } })
                }
                if (document.getElementById("radarChart")) {
                    var X = document.getElementById("radarChart").getContext("2d");
                    new Chart(X, { type: "RadarWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scale: { ticks: { display: !1 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: t, backgroundColor: c, data: [80, 90, 70] }, { label: "Order", borderWidth: 2, pointBackgroundColor: r, borderColor: r, backgroundColor: p, data: [68, 80, 95] }], labels: ["Cakes", "Desserts", "Cupcakes"] } })
                }
                if (document.getElementById("polarChart")) {
                    var Y = document.getElementById("polarChart").getContext("2d");
                    new Chart(Y, { type: "PolarWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scale: { ticks: { display: !1 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 50] }], labels: ["Cakes", "Desserts", "Cupcakes"] } })
                }
                if (document.getElementById("polarChartNoShadow")) {
                    var G = document.getElementById("polarChartNoShadow").getContext("2d");
                    new Chart(G, { type: "polarArea", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scale: { ticks: { display: !1 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 70] }], labels: ["Cakes", "Desserts", "Cupcakes"] } })
                }
                if (document.getElementById("salesChartNoShadow")) {
                    var J = document.getElementById("salesChartNoShadow").getContext("2d");
                    new Chart(J, { type: "line", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 20 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: "", data: [54, 63, 60, 65, 60, 68, 60], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 6, pointBorderWidth: 2, pointHoverRadius: 8, fill: !1 }] } })
                }
                if (document.getElementById("productChart")) {
                    var j = document.getElementById("productChart").getContext("2d");
                    new Chart(j, { type: "BarWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 100, min: 300, max: 800, padding: 20 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { labels: ["January", "February", "March", "April", "May", "June"], datasets: [{ label: "Cakes", borderColor: t, backgroundColor: c, data: [456, 479, 324, 569, 702, 600], borderWidth: 2 }, { label: "Desserts", borderColor: r, backgroundColor: p, data: [364, 504, 605, 400, 345, 320], borderWidth: 2 }] } })
                }
                if (document.getElementById("productChartNoShadow")) {
                    var Q = document.getElementById("productChartNoShadow").getContext("2d");
                    new Chart(Q, { type: "bar", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 100, min: 300, max: 800, padding: 20 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z }, data: { labels: ["January", "February", "March", "April", "May", "June"], datasets: [{ label: "Cakes", borderColor: t, backgroundColor: c, data: [456, 479, 324, 569, 702, 600], borderWidth: 2 }, { label: "Desserts", borderColor: r, backgroundColor: p, data: [364, 504, 605, 400, 345, 320], borderWidth: 2 }] } })
                }
                var K = { type: "LineWithShadow", options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, scales: { yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 20 } }], xAxes: [{ gridLines: { display: !1 } }] }, legend: { display: !1 }, tooltips: z }, data: { labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], datasets: [{ borderWidth: 2, label: "", data: [54, 63, 60, 65, 60, 68, 60, 63, 60, 65, 60, 68], borderColor: t, pointBackgroundColor: f, pointBorderColor: t, pointHoverBackgroundColor: t, pointHoverBorderColor: f, pointRadius: 4, pointBorderWidth: 2, pointHoverRadius: 5, fill: !1 }] } };
                ...
                if (document.getElementById("categoryChart")) {
                    ...
                    new Chart(te, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [s, r, t], backgroundColor: [u, p, c], borderWidth: 2, data: [15, 25, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("categoryChartNoShadow")) {
                    var ae = document.getElementById("categoryChartNoShadow");
                    new Chart(ae, { plugins: [ee], type: "doughnut", data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [s, r, t], backgroundColor: [u, p, c], borderWidth: 2, data: [15, 25, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("pieChartNoShadow")) {
                    var ne = document.getElementById("pieChartNoShadow");
                    new Chart(ne, { type: "pie", data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("pieChart")) ne = document.getElementById("pieChart"), new Chart(ne, { type: "PieWithShadow", data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } });
                if (document.getElementById("frequencyChart")) {
                    var oe = document.getElementById("frequencyChart");
                    new Chart(oe, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["Adding", "Editing", "Deleting"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("ageChart")) {
                    var ie = document.getElementById("ageChart");
                    new Chart(ie, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["12-24", "24-30", "30-40", "40-50", "50-60"], datasets: [{ label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 30, 14] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("genderChart")) {
                    var re = document.getElementById("genderChart");
                    new Chart(re, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["Male", "Female", "Other"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [85, 45, 20] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("workChart")) {
                    var se = document.getElementById("workChart");
                    new Chart(se, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["Employed for wages", "Self-employed", "Looking for work", "Retired"], datasets: [{ label: "", borderColor: [t, r, s, l], backgroundColor: [c, p, u, h], borderWidth: 2, data: [15, 25, 20, 8] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
                if (document.getElementById("codingChart")) {
                    var le = document.getElementById("codingChart");
                    new Chart(le, { plugins: [ee], type: "DoughnutWithShadow", data: { labels: ["Python", "JavaScript", "PHP", "Java", "C#"], datasets: [{ label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 8, 25] }] }, draw: function() {}, options: { plugins: { datalabels: { display: !1 } }, responsive: !0, maintainAspectRatio: !1, cutoutPercentage: 80, title: { display: !1 }, layout: { padding: { bottom: 20 } }, legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } }, tooltips: z } })
                }
            }
            if ($().fullCalendar) {
                var de = new Date((new Date).setHours((new Date).getHours()));
                de.getDate(), de.getMonth();
                $(".calendar").fullCalendar({ themeSystem: "bootstrap4", height: "auto", isRTL: i, buttonText: { today: "Today", month: "Month", week: "Week", day: "Day", list: "List" }, bootstrapFontAwesome: { prev: " simple-icon-arrow-left", next: " simple-icon-arrow-right", prevYear: " simple-icon-control-start", nextYear: " simple-icon-control-end" }, events: [{ title: "Account", start: "2018-05-18" }, { title: "Delivery", start: "2019-07-22", end: "2019-07-24" }, { title: "Conference", start: "2019-06-07", end: "2019-06-09" }, { title: "Delivery", start: "2019-09-03", end: "2019-09-06" }, { title: "Meeting", start: "2019-06-17", end: "2019-06-18" }, { title: "Taxes", start: "2019-08-07", end: "2019-08-09" }] })
            }
            if ($().DataTable) {
                $(".data-table-standard").DataTable({ bLengthChange: !1, searching: !1, destroy: !0, info: !1, sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-right"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>', pageLength: 6, language: { paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" } }, drawCallback: function() { $($(".dataTables_wrapper .pagination li:first-of-type")).find("a").addClass("prev"), $($(".dataTables_wrapper .pagination li:last-of-type")).find("a").addClass("next"), $(".dataTables_wrapper .pagination").addClass("pagination-sm") } }), $(".data-tables-pagination").DataTable({ bLengthChange: !1, searching: !1, destroy: !0, info: !1, sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-right"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>', pageLength: 8, language: { paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" } }, drawCallback: function() { $($(".dataTables_wrapper .pagination li:first-of-type")).find("a").addClass("prev"), $($(".dataTables_wrapper .pagination li:last-of-type")).find("a").addClass("next"), $(".dataTables_wrapper .pagination").addClass("pagination-sm") } }), $(".data-table-scrollable").DataTable({ searching: !1, bLengthChange: !1, destroy: !0, info: !1, paging: !1, sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-right"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>', responsive: !0, deferRender: !0, scrollY: "calc(100vh - 400px)", scrollCollapse: !0, fnInitComplete: function() { new PerfectScrollbar(".dataTables_scrollBody", { suppressScrollX: !0 }).isRtl = !1 }, fnDrawCallback: function(e) { new PerfectScrollbar(".dataTables_scrollBody", { suppressScrollX: !0 }).isRtl = !1 } }), $(".data-table-feature").DataTable({ sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>', columns: [{ data: "name" }, { data: "position" }, { data: "office" }, { data: "age" }, { data: "start_date" }, { data: "salary" }], drawCallback: function() { $($(".dataTables_wrapper .pagination li:first-of-type")).find("a").addClass("prev"), $($(".dataTables_wrapper .pagination li:last-of-type")).find("a").addClass("next"), $(".dataTables_wrapper .pagination").addClass("pagination-sm") }, language: { paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" }, search: "_INPUT_", searchPlaceholder: "Search...", lengthMenu: "Items Per Page _MENU_" } });
                ...
                function pe() { $("#datatableRows tbody tr").removeClass("selected"), $("#datatableRows tbody tr .custom-checkbox input").prop("checked", !1).trigger("change") }
                $("#dataTablesCopy").on("click", (function(e) { e.preventDefault(), ce.buttons(0).trigger() })), $("#dataTablesExcel").on("click", (function(e) { e.preventDefault(), ce.buttons(1).trigger() })), $("#dataTablesCsv").on("click", (function(e) { e.preventDefault(), ce.buttons(2).trigger() })), $("#dataTablesPdf").on("click", (function(e) { e.preventDefault(), ce.buttons(3).trigger() })), $("#datatableRows tbody").on("click", "tr", (function() {
                    ...
                    e.prop("checked", !e.prop("checked")).trigger("change"),
                        function() {
                            var e = !1,
                                t = !0;
                            $("#datatableRows tbody tr .custom-checkbox input").each((function() { $(this).prop("checked") ? e = !0 : t = !1 })), e ? $("#checkAllDataTables").prop("indeterminate", e) : ($("#checkAllDataTables").prop("indeterminate", e), $("#checkAllDataTables").prop("checked", e));
                            t && ($("#checkAllDataTables").prop("indeterminate", !1), $("#checkAllDataTables").prop("checked", t))
                        }()
                })), $("#checkAllDataTables").on("click", (function(e) { $("#checkAllDataTables").prop("checked") ? ($("#datatableRows tbody tr").addClass("selected"), $("#datatableRows tbody tr .custom-checkbox input").prop("checked", !0).trigger("change")) : pe() })), $("#searchDatatable").on("keyup", (function(e) { ce.search($(this).val()).draw() })), $("#pageCountDatatable .dropdown-menu a").on("click", (function(e) {
                    var t = $(this).text();
                    ce.page.len(parseInt(t)).draw()
                }));
                var ue = $("#addToDatatable").stateButton();
                $("#rightModal").on("shown.bs.modal", (function(e) { $("#addToDatatableForm").validate({ rules: { Sales: { required: !0, number: !0, min: 3e3 }, Stock: { required: !0, number: !0 }, Category: { required: !0 }, Name: { required: !0 } } }) })), $("#addToDatatable").on("click", (function(e) {
                    if ($("#addToDatatableForm").valid()) {
                        ue.showSpinner();
                        var t = $("#addToDatatableForm").find(":input"),
                            a = {};
                        t.each((function() { a[$(this).attr("name")] = $(this).val() })), a.Check = '<label class="custom-control custom-checkbox mb-1 align-self-center data-table-rows-check"><input type="checkbox" class="custom-control-input"><span class="custom-control-label">&nbsp;</span></label>', ce.row.add(a).draw(), setTimeout((function() { ue.showSuccess(!0, "New row added!"), setTimeout((function() { $("#rightModal").modal("toggle"), ue.reset(), t.each((function() { $(this).val("") })), $("#addToDatatableForm").find("select").data("select2") && $("#addToDatatableForm").find("select").val("").trigger("change"), $("#addToDatatableForm").validate().resetForm() }), 1e3) }), 1e3)
                    }
                }))
            }
            $("body").on("click", ".notify-btn", (function(e) {
                var t, a, n;
                e.preventDefault(), t = $(this).data("from"), a = $(this).data("align"), n = "primary", $.notify({ title: "Bootstrap Notify", message: "Here is a notification!", target: "_blank" }, { element: "body", position: null, type: n, allow_dismiss: !0, newest_on_top: !1, showProgressbar: !1, placement: { from: t, align: a }, offset: 20, spacing: 10, z_index: 1031, delay: 4e3, timer: 2e3, url_target: "_blank", mouse_over: null, animate: { enter: "animated fadeInDown", exit: "animated fadeOutUp" }, onShow: null, onShown: null, onClose: null, onClosed: null, icon_type: "class", template: '<div data-notify="container" class="col-11 col-sm-3 alert  alert-{0} " role="alert"><button type="button" aria-hidden="true" class="close" data-notify="dismiss">×</button><span data-notify="icon"></span> <span data-notify="title">{1}</span> <span data-notify="message">{2}</span><div class="progress" data-notify="progressbar"><div class="progress-bar progress-bar-{0}" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div></div><a href="{3}" target="{4}" data-notify="url"></a></div>' })
            ...
            })), $().slick && ($(".slick.basic").slick({ dots: !0, infinite: !0, speed: 300, rtl: i, slidesToShow: 3, slidesToScroll: 4, appendDots: $(".slick.basic").parents(".slick-container").find(".slider-dot-container"), prevArrow: $(".slick.basic").parents(".slick-container").find(".slider-nav .left-arrow"), nextArrow: $(".slick.basic").parents(".slick-container").find(".slider-nav .right-arrow"), customPaging: function(e, t) { return '<button role="button" class="slick-dot"><span></span></button>' }, responsive: [{ breakpoint: 1024, settings: { slidesToShow: 2, slidesToScroll: 2, infinite: !0, dots: !0 } }, { breakpoint: 600, settings: { slidesToShow: 1, slidesToScroll: 1 } }] }), $(".slick.center").slick({ dots: !0, infinite: !0, centerMode: !0, speed: 300, rtl: i, slidesToShow: 4, slidesToScroll: 4, appendDots: $(".slick.center").parents(".slick-container").find(".slider-dot-container"), prevArrow: $(".slick.center").parents(".slick-container").find(".slider-nav .left-arrow"), nextArrow: $(".slick.center").parents(".slick-container").find(".slider-nav .right-arrow"), customPaging: function(e, t) { return '<button role="button" class="slick-dot"><span></span></button>' }, responsive: [{ breakpoint: 992, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: !0, dots: !0, centerMode: !1 } }, { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2, centerMode: !1 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1, centerMode: !1 } }] }), $(".slick.single").slick({ dots: !0, infinite: !0, rtl: i, speed: 300, appendDots: $(".slick.single").parents(".slick-container").find(".slider-dot-container"), prevArrow: $(".slick.single").parents(".slick-container").find(".slider-nav .left-arrow"), nextArrow: $(".slick.single").parents(".slick-container").find(".slider-nav .right-arrow"), customPaging: function(e, t) { return '<button role="button" class="slick-dot"><span></span></button>' } }));
            var he = document.getElementsByClassName("needs-validation");
            Array.prototype.filter.call(he, (function(e) { e.addEventListener("submit", (function(t) {!1 === e.checkValidity() && (t.preventDefault(), t.stopPropagation()), e.classList.add("was-validated") }), !1) })), $().tooltip && $('[data-toggle="tooltip"]').tooltip(), $().popover && $('[data-toggle="popover"]').popover({ trigger: "focus" }), $().select2 && $(".select2-single, .select2-multiple").select2({ theme: "bootstrap", dir: o, placeholder: "", maximumSelectionSize: 6, containerCssClass: ":all:" }), $().datepicker && ($("input.datepicker").datepicker({ autoclose: !0, rtl: i, templates: { leftArrow: '<i class="simple-icon-arrow-left"></i>', rightArrow: '<i class="simple-icon-arrow-right"></i>' } }), $(".input-daterange").datepicker({ autoclose: !0, rtl: i, templates: { leftArrow: '<i class="simple-icon-arrow-left"></i>', rightArrow: '<i class="simple-icon-arrow-right"></i>' } }), $(".input-group.date").datepicker({ autoclose: !0, rtl: i, templates: { leftArrow: '<i class="simple-icon-arrow-left"></i>', rightArrow: '<i class="simple-icon-arrow-right"></i>' } }), $(".date-inline").datepicker({ autoclose: !0, rtl: i, templates: { leftArrow: '<i class="simple-icon-arrow-left"></i>', rightArrow: '<i class="simple-icon-arrow-right"></i>' } })), $().dropzone && !$(".dropzone").hasClass("disabled") && $(".dropzone").dropzone({ url: "https://httpbin.org/post", init: function() { this.on("success", (function(e, t) { console.log(t) })) }, thumbnailWidth: 160, previewTemplate: '<div class="dz-preview dz-file-preview mb-3"><div class="d-flex flex-row "><div class="p-0 w-30 position-relative"><div class="dz-error-mark"><span><i></i></span></div><div class="dz-success-mark"><span><i></i></span></div><div class="preview-container"><img data-dz-thumbnail class="img-thumbnail border-0" /><i class="simple-icon-doc preview-icon" ></i></div></div><div class="pl-3 pt-2 pr-2 pb-1 w-70 dz-details position-relative"><div><span data-dz-name></span></div><div class="text-primary text-extra-small" data-dz-size /><div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress></span></div><div class="dz-error-message"><span data-dz-errormessage></span></div></div></div><a href="#/" class="remove" data-dz-remove><i class="glyph-icon simple-icon-trash"></i></a></div>' });
            var me, ge = window.Cropper;
            if (void 0 !== ge) {
                function fe(e, t) { var a, n = e.length; for (a = 0; a < n; a++) t.call(e, e[a], a, e); return e }
                var be = document.querySelectorAll(".cropper-preview"),
                    Ce = {
                        ...
                        ready: function() {
                            ...
                            e.className = "", e.style.cssText = "display: block;width: 100%;min-width: 0;min-height: 0;max-width: none;max-height: none;", fe(be, (function(t) { t.appendChild(e.cloneNode()) }))
                        },
                        crop: function(e) {
                            var t = e.detail,
            ...
            "undefined" != typeof noUiSlider && ($("#dashboardPriceRange").length > 0 && noUiSlider.create($("#dashboardPriceRange")[0], { start: [800, 2100], connect: !0, tooltips: !0, direction: o, range: { min: 200, max: 2800 }, step: 10, format: { to: function(e) { return "$" + $.fn.addCommas(Math.floor(e)) }, from: function(e) { return e } } }), $("#doubleSlider").length > 0 && noUiSlider.create($("#doubleSlider")[0], { start: [800, 1200], connect: !0, tooltips: !0, direction: o, range: { min: 500, max: 1500 }, step: 10, format: { to: function(e) { return "$" + $.fn.addCommas(Math.round(e)) }, from: function(e) { return e } } }), $("#singleSlider").length > 0 && noUiSlider.create($("#singleSlider")[0], { start: 0, connect: !0, tooltips: !0, direction: o, range: { min: 0, max: 150 }, step: 1, format: { to: function(e) { return $.fn.addCommas(Math.round(e)) }, from: function(e) { return e } } })), $("#exampleModalContent").on("show.bs.modal", (function(e) {
            ...
            if ("undefined" != typeof ClassicEditor && ClassicEditor.create(document.querySelector("#ckEditorClassic")).catch((function(e) {})), $("body > *").css({ opacity: 0 }), setTimeout((function() { $("body").removeClass("show-spinner"), $("main").addClass("default-transition"), $(".sub-menu").addClass("default-transition"), $(".main-menu").addClass("default-transition"), $(".theme-colors").addClass("default-transition"), $("body > *").animate({ opacity: 1 }, 100) }), 300), "undefined" != typeof Mousetrap && (Mousetrap.bind(["ctrl+down", "command+down"], (function(e) { var t = $(".sub-menu li.active").next(); return 0 == t.length && (t = $(".sub-menu li.active").parent().children().first()), window.location.href = t.find("a").attr("href"), !1 })), Mousetrap.bind(["ctrl+up", "command+up"], (function(e) { var t = $(".sub-menu li.active").prev(); return 0 == t.length && (t = $(".sub-menu li.active").parent().children().last()), window.location.href = t.find("a").attr("href"), !1 })), Mousetrap.bind(["ctrl+shift+down", "command+shift+down"], (function(e) {
                    ...
                    var a = t.find("a").attr("href").replace("#", ""),
                        n = $(".sub-menu ul[data-link='" + a + "'] li:first-of-type");
                    return window.location.href = n.find("a").attr("href"), !1
                })), $(".list") && $(".list").length > 0 && (Mousetrap.bind(["ctrl+a", "command+a"], (function(e) { return $(".list").shiftSelectable().data("shiftSelectable").selectAll(), !1 })), Mousetrap.bind(["ctrl+d", "command+d"], (function(e) { return $(".list").shiftSelectable().data("shiftSelectable").deSelectAll(), !1 })))), $().contextMenu && $.contextMenu({
                    selector: ".list .card",
                ...
                $("#smartWizardDefault").smartWizard({
                    ...
                    transitionEffect: "fade",
                    showStepURLhash: !1,
                    anchorSettings: { enableAllAnchors: !0 }
                    ...
                    e.preventDefault();
                    var week1Form = $('#form-step-0')

                    $.ajax({
                        type: week1Form[0].method,
                        url: week1Form[0].action,
                        data: week1Form.serialize(),
                        success: function(data) {
                            alert(data);
                            var week2Form = $('#form-step-1');
                            $.ajax({
                                type: week2Form[0].method,
                                url: week2Form[0].action,
                                data: week2Form.serialize(),
                                success: function(data) {
                                    alert(data);
            ...
            if ("undefined" != typeof Countdown) {
                ...
                new Countdown({ selector: "#timer", leadingZeros: !0, msgBefore: "", msgAfter: "", msgPattern: ' <span class="timer-column"><p class="lead text-center">{days}</p><p>Days</p></span><span class="timer-column"><p class="lead text-center">{hours}</p><p>Hours</p></span><span class="timer-column"><p class="lead text-center">{minutes}</p><p>Minutes</p></span><span class="timer-column"><p class="lead text-center">{seconds}</p><p>Seconds</p></span>', dateEnd: We })
            }
